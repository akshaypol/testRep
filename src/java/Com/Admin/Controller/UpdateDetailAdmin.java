 ...
 * @author roveena
 */
@WebServlet(name = "UpdateDetailAdmin", urlPatterns = {"/UpdateDetailAdmin"})
public class UpdateDetailAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            g.setName(request.getParameter("FName"));
            ...
            response.sendRedirect("Admin/UpdateMember.jsp?id="+g.getId());
        }
    }
