...
import Com.Admin.Dao.EnquiryDao;
 ...
 * @author genesis
 */
@WebServlet(name = "NewEnquiry", urlPatterns = {"/NewEnquiry"})
...
//            e.setState(request.getParameter("State"));
            ...
            new EnquiryDao().save(e);

            int i = 1;
            HttpSession session1 = request.getSession();
            session1.setAttribute("i", i);
            session1.setAttribute("msg", "Send Message Sucessfully");
