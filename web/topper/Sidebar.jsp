...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true" style="top:60px">
    ...
    <ul class="sidebar-menu do-nicescrol">
        <li class="sidebar-header" style="border-top:white 1px solid;border-bottom: white 1px solid"><h4 class="text-white"><%=sidebarr1.getUsername()%></h4></li>
        <!--<li class="sidebar-header" style="border-top:white 1px solid;border-bottom: white 1px solid"><h4 class="text-white">My Pool:-<%=sidebarr1.getPool()%></h4></li>-->
        <li>
