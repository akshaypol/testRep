                ...
                <div class="card-body">
                    <div class="card-content p-2">
                        <div class="text-center">
                            <!--<img src="../MyImg/ylogoN.png" alt="logo icon"  width="210" height="100">-->
                        </div>
                        ...
                        <form action="../UserLogin" method="post">
                            <div class="form-group">
                                <div class="position-relative has-icon-right">
                                    ...
                                    <input type="text" id="exampleInputUsername" name="User_ID" class="form-control form-control-rounded" placeholder="Username">
