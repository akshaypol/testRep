                                ...
                                <div class="card-body"> 
                                    ...
                                    <div class="tab-content">
                                        <div id="tabe-13" class="container tab-pane active">
                                            ...
                                            %>
                                            <form id="form_validation" action="../UpdateDetail123"  method="POST">
                                            ...
                                            <form id="form_validation" action="../ChangePassword1"  method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="text" autocomplete="off" required="" value="<%=g.getUsername()%>" placeholder="Reset" class="form-control" name="UserName">
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <label for="personName" class="form-label">Reset Password</label>
                                                        <input type="text" autocomplete="off" required="" value="<%=g.getPassword()%>" placeholder="Reset" class="form-control" name="Password">
                                                    </div>
