    ...
    <tbody>
        ...
        <%
            ...
            for (MemberModel h5 : Leads) {
                if (!h5.getAdmin().equals("Admin") && h5.isStatus() == true) {
        %>
        <tr>
            <td><%=i2%></td>
            <td><%=h5.getUsername()%></td>
            <td><%=h5.getPassword()%></td>
            <td><%=h5.getName()%></td>
            ...
            <td> 
                ...
                <a href="#" id="<%=h5.getId()%>" class="btn-sm btn btn-danger shadow-danger btn-round waves-effect waves-light deleteID" data-toggle="modal" data-target="#modal-animation-10">Delete</a>
                <a href="ViewDocument.jsp?id=<%=h5.getId()%>"  class="btn-sm btn btn-danger shadow-danger btn-round waves-effect waves-light " >View Documents</a>


                <!--<input type="text" value%>"  id="deelteID">-->
            </td>
