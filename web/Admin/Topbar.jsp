...
<%@page import="Com.Admin.Model.SuperAdminLogin"%>
...
<header class="topbar-nav">
    <nav class="navbar navbar-expand fixed-top mytopbar">
        <ul class="navbar-nav mr-auto align-items-center">
            <li class="nav-item" style="padding-right:10px"><img class=""  src="../wecare.png" alt="Logo" width="40" height="40" /></li>

            <li class="nav-item"> <span class="HedaerName">WeCare Enterprises</span></li>
            <li class="nav-item">
        ...
        <ul class="navbar-nav align-items-center right-nav-link">
            ...
            <li style="color:white;margin-right:20px; "><%=sidebarr.getUsername()%></li>
                        ...
                        <a href="javaScript:void();">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="user-subtitle"><%=sidebarr.getEmail()%></p>
                                </div>
                            </div>
                        </a>
                    </li>
<!--                    <li class="dropdown-divider"></li>
                    ...
                    <li class="dropdown-divider"></li>
                    <li class="dropdown-item"><a href="../LogoutAdmin"><i class="icon-power mr-2"></i> Logout</a></li>
                </ul>
            </li>
