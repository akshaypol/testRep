                                            ...
                                            <table id="example" class="table table-bordered">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=m.getWamount()%></td>
                                                        <td> 
                                                            <a href="../../PaidUser?MId=<%=m.getUserID()%>&Amount=<%=m.getWamount()%>&WMID=<%=m.getId()%>" class="btn-sm btn btn-primary shadow-primary btn-round btn-block waves-effect waves-light">Paid</a>
