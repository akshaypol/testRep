                                ...
                                <div class="card-body"> 
                                    ...
                                    <div class="tab-content">
                                        <div id="tabe-13" class="container tab-pane active">
                                            ...
                                            %>
                                            <form id="form_validation" action="../UpdateDetail"  method="POST">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="text"  autocomplete="off" required="" value="<%=g.getName()%>" class="form-control" name="personName" >
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="text" autocomplete="off" required="" value="<%=g.getOccupation()%>" class="form-control" name="Occupation" >
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input type="number" autocomplete="off" required="" value="<%=g.getAge()%>" class="form-control" name="Age" >
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                       <label for="personName" class="form-label">Member Of charch</label>
                                                        <input type="text" autocomplete="off" required="" value="<%=g.getMcharch()%>" class="form-control" name="MemCharch" >
                                     
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <label for="personName" class="form-label">City</label>
                                                        <input type="text" autocomplete="off" required="" value="<%=g.getCity()%>" class="form-control" name="City" >
                                                    </div>
