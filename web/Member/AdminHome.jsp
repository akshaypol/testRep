            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <%
                        ...
                        MemberModel mm = new MemberDao().getById(sidebarr1.getId());
                        TransactionModel tm = new TransactionDao().getUserID(mm.getId());
                    %>
                    
                    <%
                    if(mm.getPool()==0)
                    {
                          MemberModel k= new MemberDao().getById(mm.getGivingID());
