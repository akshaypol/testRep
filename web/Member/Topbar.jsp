...
<header class="topbar-nav">
    <nav class="navbar navbar-expand fixed-top mytopbar">
        ...
        <ul class="navbar-nav align-items-center right-nav-link">
            ...
            <%                if(sidebarr.getGender().equals("Male"))
                
                    {%>
                    <li style="color:white;margin-right:20px; ">Welcome : Mr &nbsp;<%=sidebarr.getName()%></li>  
                    <%
                }else
            {
            %>
                <li style="color:white;margin-right:20px; ">Welcome : Mrs&nbsp;<%=sidebarr.getName()%></li>        
                    <%
            }
            %>
