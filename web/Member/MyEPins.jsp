            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header"><i class="fa fa-table"></i>My E-Pins(Sent By Me)</div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="table table-bordered">
                                            ...
                                            <tbody>
                                                <%                                                    int i = 0;
                                                    ...
                                                    List<GivenEpinModel> m = new GivenEpinDao().getByUserID(me.getId());
                                                    for (GivenEpinModel e : m) {
                                                        i++;
                                                        MemberModel mem = new MemberDao().getById(e.getGivenTo());
                                                %>
                                                <tr>
                                                    <td><%=i%></td>
