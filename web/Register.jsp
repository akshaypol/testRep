...
<html lang="en">
             ...
             .errortext1
    {
        ...
        %>
        <div class="modal fade" id="registerModle1" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="registerModle1" aria-hidden="true">
                          ...
                          <form id="form_validation" action="../SaveMemberF" onsubmit="return myfunction();"  method="POST">
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                  ...
                                  <input type="text" id="sponcerId" value=""  class="form-control" autocomplete="off"   name="SponcerID" style="text-transform: lowercase" placeholder="Sponcer ID (Optional)"> 
    
                                    <%
                                    }else
                                    {
                                        %>
                                        <input type="text" id="sponcerId" value="<%=SPID%>"  class="form-control" autocomplete="off" readonly=""  name="SponcerID" style="text-transform: lowercase" placeholder="Sponcer ID (Optional)"> 
 ...
 <span class="Nameerrortext" id="">Enter same password as above.</span>
                                </div>  
                            </div>
                            ...
                            <div class="form-group form-float">
                                ...
                                <div class="form-line">
                                    ...
                                    <span class="errortext1" id="errortext">Enter Correct Mobile Number</span>
                                </div>
                            </div>
                            <div class="form-group form-float">
                                <!--<label class="form-label">Mobile No</label>-->
